...
def gameQuit():
    gameOver(gameSceneTmp, land_1Tmp, land_2Tmp, spriteBirdTmp, True)
...
def addCollision(gameScene, gameLayer, spriteBird, pipes, land_1, land_2):
    ...
    global gameSceneTmp, land_1Tmp, land_2Tmp, spriteBirdTmp, isStart
    isStart = True
    gameSceneTmp = gameScene
    land_1Tmp = land_1
    land_2Tmp = land_2
    spriteBirdTmp = spriteBird
